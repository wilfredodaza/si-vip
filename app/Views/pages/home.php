...
<head>
    ...
    <meta name="description" content="Sistema de Información para ventans, inventarios y personal">
    <meta name="keywords" content="">
    <meta name="author" content="IPlanetColomba S.A.S">
    <title>SIVIP - IPlanet Colombia SAS</title>
    ...
    <link rel="shortcut icon" href="<?= base_url('/assets/img/sivip.png') ?>" type="image/png">
