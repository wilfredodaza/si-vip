...
<?= $this->section('styles') ?>
<link rel="stylesheet" href="<?= base_url('js/angular/expenses_create/styles.css') ?>">
...
<script src="<?= base_url('js/angular/expenses_create/runtime.js') ?>" defer></script>
<script src="<?= base_url('js/angular/expenses_create/polyfills.js') ?>" defer></script>
<script src="<?= base_url('js/angular/expenses_create/main.js') ?>" defer></script>
